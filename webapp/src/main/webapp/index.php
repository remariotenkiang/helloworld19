...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.php">SantosBookMyBusTicket</a></h1>
				<nav id="nav">
					<ul>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Welcome to SantosBookMyBusTicket</h2>
		...
		<a name="about"></a>
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>SantosBookMyBusTicket</h2>
						<p> <b>SantosBookMyBusTicket is a online bus reservation system. <br>You can now choose your bus and your seat easily, have the tickets delivered to your mail and online payments. <br>Try BookMyBusTicket experience today.</b></p>
		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<p><b> Why SantosBookMyBusTicket for Bus Booking? </b>
...
<br> <br>
<p><b>Booking Bus Ticket with SantosBookMyBusTicket</b> <br>
		...
		<!-- Footer -->
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								...
								<li>
									<h3>Mail</h3>
									<a href="#">dinhoromario@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									(302) 379-7457
					...
					<ul class="copyright">
						<li>&copy; 2020 SantosBookMyBusTicket. All rights reserved. Brought To You By <a href="https://code-projects.org/">Code-Projects</a></li>
